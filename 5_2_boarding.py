...
def find_missing_seat(seat_id_list):
    seat_id_set = set(seat_id_list)
    first = min(seat_id_list)
    last = max(seat_id_list)
    seat_range_set = set([x for x in range(first, last+1)])
    return seat_range_set - seat_id_set
